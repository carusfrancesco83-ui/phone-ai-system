...
const CHAT_ID_MAP = {
  ...
  ANALISI_DEI_DATI:     process.env.TELEGRAM_CHAT_ANALISI_DEI_DATI,
  RIPRISTINO_MANUFATTI: process.env.TELEGRAM_CHAT_RIPRISTINO_MANUFATTI,
  IMPERMEABILIZZAZIONE: process.env.TELEGRAM_CHAT_IMPERMEABILIZZAZIONE,
  PROVE_DI_TENUTA:      process.env.TELEGRAM_CHAT_PROVE_DI_TENUTA,
