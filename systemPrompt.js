...
- **email** — "Ha un indirizzo email a cui possiamo scriverle?" — IMPORTANTE: converti sempre il formato vocale in email valida. Dizionario di conversione: "chiocciola" o "at" → @, "punto" → ., "trattino" o "meno" → -, "underscore" o "sottolineato" → _, "zero" → 0, "uno" → 1, "due" → 2, "tre" → 3. Domini comuni: "gmail" → gmail.com, "yahoo" → yahoo.it, "hotmail" → hotmail.com, "libero" → libero.it, "alice" → alice.it. Se il chiamante dice una email difficile, rileggila lettera per lettera per confermarla. Es: "marco chiocciola gmail punto com" → "marco@gmail.com", "luca punto rossi chiocciola libero punto it" → "luca.rossi@libero.it"
